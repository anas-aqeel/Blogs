  ...
  return (
    <div className=" max-w-[1450px] mx-auto">
      <div>
        ...
        <div className="mt-7">
          <img src="/images/about.svg" className="w-full h-auto" />
          <div className="mt-8 space-y-8 px-4">
            <div>
              <h1 className="text-black dark:text-white text-2xl font-semibold">
                About Me
              </h1>
              <p className="text-[#919396] dark:text-[#C0C5D0] text-base mt-3">
            ...
            <div>
              ...
              <ul className="text-[#919396] dark:text-[#C0C5D0] text-base mt-3 list-disc list-outside ml-5">
                <li>
                  {' '}
