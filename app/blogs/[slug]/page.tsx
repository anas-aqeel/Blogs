...
const page = () => {
  return (
    <>
      <div className="pt-36 max-w-[1450px] mx-auto px-5 z-40 absolute  left-0 right-0 ">
        <div className="text-black max-w-4xl  font-medium z-50 font-sans">
          ...
          <h3 className="text-gray-800 mt-5">
            Before going digital, you might scribbling down some ideas in a
            sketchbook.
          </h3>
        </div>
        <div className="max-w-[1450px] flex  mx-auto bg-[#1b2937] text-gray-300 rounded p-10 mt-12">
          <div className=''>
            <div className="flex">
              <h1>
      ...
      <img
        className="w-full h-auto absolute top-0 left-0 right-0 z-0 opacity-60"
        src="/images/blog.svg"
      />
    </>
  )
